...
<div class="container">
    <div id="question-tool">
        ...
        <?php
        if ($sort == 'ta.time') {
            echo "<p>Currently sorted by <b>last modified time</b>. <a href='question_tool.php?key=".urlencode($_REQUEST['key'])."'>Sort by original submission time?</a></p>";
        } else {
            echo "<p>Currently sorted by <b>original submission time</b>. <a href='question_tool.php?key=".urlencode($_REQUEST['key'])."&amp;sort_key=time'>Sort by last modified time?</a></p>";
        }
        ?>
