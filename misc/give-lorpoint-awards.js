    ...
    db.query(
      ...
      function (err, rows) {
        ...
        rows.forEach(function (member) {
          ...
          let awardText = rank  + getSuffix(rank) + ' Place - Lorpoints Season 1 (' + member.lorpoints + ' ' + word + ')';
          db.query("INSERT INTO awards (server, member, award, date) VALUES (?,?,?,CURDATE())", [config.mainServer, member.id, awardText]);
        });
      }
    );
  }
